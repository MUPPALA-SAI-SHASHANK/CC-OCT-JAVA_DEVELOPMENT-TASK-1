...
public class SignIn {
	...
	private void displayLogin() {
		...
		JLabel background=getBackground(700,650,"image.png") ;
		...
		JLabel l0=new JLabel("Welcome Back ! Login to Your Account");
		...
		panel.add(l2) ;
		panel.add(p1) ;
		panel1.setBounds(190,190,300,60);
		panel.setBounds(190,250,300,60);
		JPanel panelbutton=new JPanel(new FlowLayout(FlowLayout.CENTER)) ;
		panelbutton.add(b2) ;
		panelbutton.add(b1) ;
		panelbutton.setBounds(260,450,200,50);
	...
	public void displayMailFunctions(String user){
		...
		functionFrame.getContentPane().setBackground(Color.WHITE);
		Color c1=new Color(6,61,255);
		...
		functionFrame.setTitle("Welcome: "+server+" User-Name : "+user) ;
		functionFrame.setSize(1200,700) ;
		JLabel background=getBackground(1200,700,"image1.jpg") ;
		...
		compose.setBackground(Color.CYAN);
		compose.setForeground(c1);
		JButton unread_email=new JButton("Unread Emails") ;
		unread_email.setBackground(Color.CYAN);
		unread_email.setForeground(c1);
		JButton read_email=new JButton("Read Emails") ;
		read_email.setBackground(Color.CYAN);
		read_email.setForeground(c1);
		JButton sent_email=new JButton("Sent Emails") ;
		sent_email.setBackground(Color.CYAN);
		sent_email.setForeground(c1);
		...
		logout.addActionListener(new ActionListener() {public void actionPerformed(ActionEvent e) {
			dialog.showMessageDialog(content_pane,"Logging Out...!\nHope to see You Again !",
